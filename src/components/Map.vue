...
function convertCoords(rawEtrsX: string, rawEtrsY: string): [float, float] {
  const etrsX: float = parseFloat(rawEtrsX);
  const etrsY: float = parseFloat(rawEtrsY);
